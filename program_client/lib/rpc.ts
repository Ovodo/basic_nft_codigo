...
export const getGem = async (
  ...
  const buffer = await _connection.getAccountInfo(
    publicKey,
    commitmentOrConfig
  );
...
export module CslSplTokenGetters {
  export const getMint = async (
    ...
    return T.CslSplTokenTypes.decodeMint(
      deserialize(T.CslSplTokenTypes.MintSchema, buffer.data) as Record<
        string,
        unknown
      >
    );
  ...
  export const getAccount = async (
    ...
    return T.CslSplTokenTypes.decodeAccount(
      deserialize(T.CslSplTokenTypes.AccountSchema, buffer.data) as Record<
        string,
        unknown
      >
    );
